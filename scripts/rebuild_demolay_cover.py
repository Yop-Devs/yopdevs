"""Rebuild Capítulo 862 DeMolay portfolio cover: logo + mosaic."""
from pathlib import Path
from PIL import Image, ImageDraw, ImageFilter, ImageEnhance

SAFE = Path(r"c:\Users\gabri\yopdevs\public\projetos\prints\demolay\safe")
OUT = Path(r"c:\Users\gabri\yopdevs\public\projetos\prints\demolay.png")
LOGO_SRC = Path(r"c:\Users\gabri\yopdevs\public\projetos\demolay\logo.png")
...
W, H = 1920, 1080
canvas = Image.new("RGB", (W, H), (6, 12, 28))

glow = Image.new("RGB", (W, H), (6, 12, 28))
gd = ImageDraw.Draw(glow)
gd.ellipse((-120, 100, 720, 980), fill=(30, 55, 120))
gd.ellipse((900, -100, 2100, 700), fill=(120, 80, 20))
...
for x in range(0, W, 48):
    gdraw.line([(x, 0), (x, H)], fill=(80, 140, 220, 14))
for y in range(0, H, 48):
    gdraw.line([(0, y), (W, y)], fill=(80, 140, 220, 14))
...
bp.rounded_rectangle((0, 0, brand_w - 1, 879), radius=28, fill=(4, 10, 24, 235))
bp.rounded_rectangle((0, 0, brand_w - 1, 879), radius=28, outline=(200, 160, 60, 110), width=2)
...
bp.text((brand_w // 2, 790), "CAPÍTULO 862", fill=(230, 200, 120, 230), anchor="mm")
bp.text((brand_w // 2, 828), "Ordem DeMolay", fill=(170, 190, 220, 180), anchor="mm")
