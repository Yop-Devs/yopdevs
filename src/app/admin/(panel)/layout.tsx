    ...
    <div className="fixed inset-0 flex overflow-hidden bg-slate-100 text-slate-900">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="flex items-center gap-3 border-b border-slate-200 bg-white px-4 py-3 lg:px-6">
          ...
          <div>
            <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-violet-700">Área admin</p>
            <h1 className="text-sm font-bold text-slate-900 sm:text-base">Painel YOP Devs</h1>
          </div>
        </header>
