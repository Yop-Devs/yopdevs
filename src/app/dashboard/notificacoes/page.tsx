  ...
  return (
    <div className="max-w-[1000px] mx-auto py-12 px-6 space-y-10">
      ...
      <div className="space-y-4">
        {notifications.map((n) => (
          <div key={n.id} className="bg-white border-2 border-slate-900 p-5 rounded-2xl flex items-center gap-6 hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all group">
            ...
            <div className={`w-2 h-2 rounded-full ${n.is_read ? 'bg-transparent' : 'bg-indigo-600 animate-pulse'}`}></div>
          </div>
        ))}
