    ...
    <section id="education" className="py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto mb-12 grid max-w-4xl grid-cols-1 gap-4 md:grid-cols-2">
          {EDUCATION_ORDER.map((key, i) => {
            const item = t.education.items[key]
            return (
              <PortfolioReveal key={key} variant="up" delay={((i % 4) + 1) as 1 | 2 | 3 | 4}>
                <div className="glass rounded-xl p-5 transition-colors hover:border-[hsl(var(--primary)/0.35)]">
        ...
        <div className="mx-auto max-w-3xl">
          <PortfolioReveal variant="blur" delay={2}>
