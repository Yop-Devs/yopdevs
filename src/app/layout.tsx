...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  // Enquanto verifica a sessão, mostra o loading para segurança
  if (loading) return (
      ...
      <aside className="w-64 bg-slate-900 flex flex-col border-r border-slate-800">
        ...
        <div className="p-4 bg-slate-950 border-t border-slate-800 flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[10px] font-black text-white truncate uppercase tracking-tighter">{profile?.full_name || 'Usuário'}</p>
