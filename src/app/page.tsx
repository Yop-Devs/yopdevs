...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-indigo-500/30 overflow-x-hidden">
      ...
      {/* HERO SECTION - Responsividade de Tipografia */}
      <section className="relative pt-40 md:pt-48 pb-20 px-6">
        <div className="max-w-6xl mx-auto text-center relative z-10">
          <h1 className="text-4xl md:text-6xl lg:text-[110px] font-black italic tracking-tighter uppercase leading-[0.9] md:leading-[0.8] mb-10">
            Engineered for <br />
          ...
          <p className="text-slate-400 max-w-3xl mx-auto text-base md:text-2xl font-medium leading-relaxed mb-12">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center">
            <button onClick={() => { setMode('signup'); setShowModal(true); }} className="px-12 py-5 md:py-6 bg-indigo-600 rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-indigo-500 transition-all shadow-2xl shadow-indigo-500/30">
              Quero Me Cadastrar
            </button>
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 md:py-32 grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          ...
          <div key={idx} className="p-8 md:p-10 rounded-[32px] bg-white/[0.02] border border-white/5 hover:border-indigo-500/50 transition-all group">
            ...
            <h3 className="text-lg md:text-xl font-black italic uppercase mb-4 tracking-tighter">{item.t}</h3>
            <p className="text-slate-500 text-sm leading-relaxed">{item.d}</p>
          </div>
        ))}
      </section>

      {/* FOOTER - Links Corrigidos com o componente Link */}
