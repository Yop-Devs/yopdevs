      ...
      <div className="max-w-3xl mx-auto w-full min-w-0 space-y-6 sm:space-y-8">
        <header className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-200 pb-6">
          <Link href="/" className="flex items-center">
            <Image src="/yop-logo.png?v=2" alt="YOP DEVS" width={220} height={70} className="h-12 w-auto object-contain" unoptimized />
          </Link>
        ...
        <h1 className="text-xl sm:text-2xl md:text-4xl font-black text-slate-900">Privacidade</h1>
